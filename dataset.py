...
def ensure_directory_exists(file_path):
    # make sure there exists the dir
...
def main(config):
    ...
    directories = os.listdir(config.origin_data_path)
    data_list = []
    GT_list = []

    for directory in directories:
        dir_path = os.path.join(config.origin_data_path, directory)
        if os.path.isdir(dir_path):
            ...
            for filename in filenames:
                ...
                if ext in ['.jpg', '.jpeg']:
                    data_list.append(f'{directory}/{filename}')
                    GT_list.append(f'{directory}/{basename}_mask.png')
...
if __name__ == '__main__':
    ...
    # data path
    parser.add_argument('--origin_data_path', type=str, default='./seaturtleid2022/turtles-data/data/images/')
    parser.add_argument('--origin_GT_path', type=str, default='./seaturtleid2022/turtles-data/data/images_GT/')
